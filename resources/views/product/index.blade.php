                ...
                @if(count($products) > 0)
                    ...
                    @foreach($products as $product)
                        @php
                           ...
                           // Construct Image URL
                           // Legacy logic used env switch, but mainly 'ims/internal/' . img2
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const weightFilters = {
        'gm0': { min: 0, max: 1 }, 'gm1': { min: 1, max: 2 }, 'gm2': { min: 2, max: 4 },
        'gm3': { min: 4, max: 8 }, 'gm4': { min: 8, max: 12 }, 'gm5': { min: 12, max: Infinity }
    };
    const sizeMapping = { 'adult': 'Adult Size', 'kids': 'Kids Size', 'baby': 'Baby Size' };

    function applyFilters() {
        const activePrice = [], activeWeight = [], activeGender = [], activeSize = [];
